...
# # Configure logging to display DEBUG messages and higher
...
def main():
    ...
    print("Train_ds",OmegaConf.to_yaml(cfg.train_ds))
    print("Validation_ds",OmegaConf.to_yaml(cfg.validation_ds))
  ...
  # Train dataset
        ...
        cfg.validation_ds.is_concat = False

        # Test dataset
        # cfg.test_ds.manifest_filepath = 

...
@hydra_runner(
    config_path="/home/asds/ml_projects_mher/NeMo-SDP-ArmData/NeMo/examples/asr/conf/fastconformer/hybrid_transducer_ctc", config_name="fastconformer_hybrid_transducer_ctc_bpe"
)
def main(cfg):
    logging.info(f'Hydra config: {OmegaConf.to_yaml(cfg)}')


    data_dir = 'asds/mozilla-foundation_copy/common_voice_16_1'
    ...
    manifest_dir = "asds/mozilla-foundation_copy/common_voice_16_1/hy-AM"
    train_manifest = f"{manifest_dir}/train/train_mozilla-foundation_common_voice_16_1_manifest.json.clean"
    dev_manifest = f"{manifest_dir}/validation/validation_mozilla-foundation_common_voice_16_1_manifest.json.clean"
    test_manifest_path = f"{manifest_dir}/test/test_mozilla-foundation_common_voice_16_1_manifest.json.clean"
    ...
    model = EncDecHybridRNNTCTCBPEModel(cfg=cfg.model, trainer=trainer)
